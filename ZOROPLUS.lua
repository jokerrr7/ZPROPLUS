...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SourceZOROPLUS/File_ZOROPLUS/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROPLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
--------------------------------------------------------------------------------------------------------------
function SourceZOROPLUS(msg,data) -- جوكر
if msg then
...
if not AliZOROPLUSW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if AliZOROPLUSW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ✫' and AliZOROPLUSW(msg) then  
...
if text == 'تعطيل التواصل ✫' and AliZOROPLUSW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and AliZOROPLUSW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and AliZOROPLUSW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and AliZOROPLUSW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯⁞ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and AliZOROPLUSW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and AliZOROPLUSW(msg) then 
...
if text == 'تحديث السورس ✫' and AliZOROPLUSW(msg) then 
os.execute('rm -rf ZOROPLUS.lua')
os.execute('https://raw.githubusercontent.com/jokerrr7/ZPROPLUS/main/ZOROPLUS.lua')
send(msg.chat_id_, msg.id_,' *⌯⁞تم تحديث السورس* \n*⌯⁞لديك اخر اصدار لسورس جارفي*\n*⌯⁞الاصدار » { 2.8v}*')
dofile('ZOROPLUS.lua')  
end
if text == 'الاصدار ✫' and AliZOROPLUSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞اصدار سورس جارفي* \n*⌯⁞الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and AliZOROPLUSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯⁞[تحديثات البوت](t.me/SOURCE_ZORO_plus) \n⌯⁞[قناه السورس](t.me/SOURCE_ZORO_plus)')
end
if text == "ضع اسم للبوت ✫" and AliZOROPLUSW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and AliZOROPLUSW(msg) then 
...
if text == 'المشتركين ✫' and AliZOROPLUSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and AliZOROPLUSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and AliZOROPLUSW(msg) then
...
if text == ("قائمه العام ✫") and AliZOROPLUSW(msg) then
...
if text == ("قائمه الكتم العام ✫") and AliZOROPLUSW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and AliZOROPLUSW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and AliZOROPLUSW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and AliZOROPLUSW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and AliZOROPLUSW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and AliZOROPLUSW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯⁞ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and AliZOROPLUSW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and AliZOROPLUSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and AliZOROPLUSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯⁞عدد الكروبات الان » { '..#group..' }'..ZOROPLUSk..''..ZOROPLUS..'*\n*⌯⁞الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and AliZOROPLUSW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and AliZOROPLUSW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and AliZOROPLUSW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and AliZOROPLUSW(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not AliZOROPLUSW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and AliZOROPLUSW(msg) then
...
if text and text:match("^تغير الاشتراك$") and AliZOROPLUSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and AliZOROPLUSW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and AliZOROPLUSW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯⁞تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and AliZOROPLUSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and AliZOROPLUSW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and AliZOROPLUSW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯⁞تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and AliZOROPLUSW(msg) then  
...
send(msg.chat_id_, msg.id_, "⌯⁞عزيزي >>["..ZOROPLUS2.username_.."](https://t.me/"..(ZOROPLUS2.username_ or "SOURCE_ZORO_plus")..")\n⌯⁞عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZOROPLUS:teh"..msg.chat_id_).."} بجانب اسمك\n⌯⁞عدد المحاولات المتبقيه {"..(tonumber(ZOROPLUS_nnn) - tonumber(ZOROPLUS_nnn2)).."}")
end
end
end
end
...
if text == 'رفع نسخه الاحتياطيه' and AliZOROPLUSW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and AliZOROPLUSW(msg) then
dofile('ZOROPLUS.lua')  
send(msg.chat_id_, msg.id_, ' *⌯⁞تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and AliZOROPLUSW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and AliZOROPLUSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and AliZOROPLUSW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and AliZOROPLUSW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and AliZOROPLUSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and AliZOROPLUSW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and AliZOROPLUSW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and AliZOROPLUSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and AliZOROPLUSW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and AliZOROPLUSW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and AliZOROPLUSW(msg) then
...
if text == 'الملفات' and AliZOROPLUSW(msg) then
...
if AliZOROPLUSW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceZOROPLUS/File_ZOROPLUS/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and AliZOROPLUSW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceZOROPLUS/File_ZOROPLUS/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and AliZOROPLUSW(msg) then
...
if text == "مسح الملفات" and AliZOROPLUSW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯⁞تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and AliZOROPLUSW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and AliZOROPLUSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح كليشه المطور' and AliZOROPLUSW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯⁞تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and AliZOROPLUSW(msg) then
...
if text == 'تفعيل الاذاعه' and AliZOROPLUSW(msg) then  
...
if text == 'تعطيل الاذاعه' and AliZOROPLUSW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not AliZOROPLUSW(msg) then 
...
if text == ("مسح ردود المطور") and AliZOROPLUSW(msg) then 
...
if text == ("ردود المطور") and AliZOROPLUSW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯⁞قائمة ردود المطور \n*•━━━━━━ 𝙯𝙤𝙧𝙤 + ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and AliZOROPLUSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and AliZOROPLUSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and AliZOROPLUSW(msg) then   
...
if text == 'تعطيل المغادره' and AliZOROPLUSW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯⁞ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOROPLUSFiles')..') '
...
-- vardump(data) 
ZOROPLUSdx(msg.chat_id_, msg.id_, ' *⌯⁞ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯⁞عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯⁞عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯⁞عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and AliZOROPLUSW(msg) then
...
*✫م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ 𝙯𝙤𝙧𝙤 + ━━━━━━━•*ٴ
[𝙘𝙝𝙖𝙣𝙣𝙚𝙡 𝙯𝙤𝙧𝙤 𝙥𝙡𝙪𝙨 𐇮](t.me/SOURCE_ZORO_plus) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𝙘𝙝𝙖𝙣𝙣𝙚𝙡 𝙯𝙤𝙧𝙤 𝙥𝙡𝙪𝙨 𐇮', url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━━━━ 𝙯𝙤𝙧𝙤 + ━━━━━━━•*ٴ✫∫○ٴ\n⌯⁞[𝙘𝙝𝙖𝙣𝙣𝙚𝙡 𝙯𝙤𝙧𝙤 𝙥𝙡𝙪𝙨 𐇮](t.me/SOURCE_ZORO_plus) ')
end
...
{{text = '𝙘𝙝𝙖𝙣𝙣𝙚𝙡 𝙯𝙤𝙧𝙤 𝙥𝙡𝙪𝙨 𐇮',url='https://t.me/SOURCE_ZORO_plus'}},
}
...
if ZOROPLUS1_Msg then
send(msg.chat_id_, msg.id_," ⌯⁞"..ZOROPLUS1_Msg)
