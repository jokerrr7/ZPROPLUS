...
local UserName = (data.username_ or "SOURCE_ZOROPLUS_plus")
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯⁞[تحديثات البوت](t.me/SOURCE_ZOROPLUS_plus) \n⌯⁞[قناه السورس](t.me/SOURCE_ZOROPLUS_plus)')
end
...
iif text == 'الاحصائيات ✫' and Sudo(msg) then
...
{
{text = 'ZOROPLUS PLUS', url = "https://t.me/SOURCE_ZOROPLUS_plus"},
},
}
...
usertext = '*\n ⌯⁞اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SOURCE_ZOROPLUS_plus')..')'
status  = '\n *⌯⁞تم ترقيته مطور*'
...
usertext = '\n *⌯⁞اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..')'
status  = '\n*⌯⁞تم ترقيته مطور*'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯⁞اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..') \n ⌯⁞'..ZOROPLUSrVi1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](t.me/SOURCE_ZOROPLUS_plus)}\n⌯⁞["..ZOROPLUSrVi_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯⁞عذرا ↫* {["..data.first_name_.."](t.me/SOURCE_ZOROPLUS_plus)}\n*⌯⁞عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_,msg.id_,'⌯⁞شترك في قناة السورس اولآ @SOURCE_ZOROPLUS_plus.') 
return false 
end 
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ᴢᴏʀᴏ ᴘʟụѕ\n\n[✫  ᴢᴏʀᴏ ᴘʟụѕ ᴄʜᴀɴɴᴇʟ](http://t.me/SOURCE_ZOROPLUS_plus)\n\n[✫ ᴄʜᴀɴɴᴇʟ](https://t.me/joinchat/g-ydeDBrho4xNmE0)\n\n[✫ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/Bahjat100)\n\n[✫ ʙᴏᴛ ᴢᴏʀᴏ ᴘʟụѕ](http://t.me/Bahjat111_bot)" 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✫ ѕᴏụʀᴄᴇ ᴢᴏʀᴏ ᴘʟụѕ',url="t.me/SOURCE_ZOROPLUS_plus"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_ZOROPLUS_plus&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*⌯⁞بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..') \n*⌯⁞تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯⁞بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..') \n*⌯⁞تـم قفـل التاك بالكتم* ')
end,nil)   
...
local TextE = "\n*•━━━━━━ ZOROPLUS ━━━━━━━•*\n *⌯⁞علامة تعني { ✓ } ملف مفعل*\n *⌯⁞علامة تعني { ✘ } ملف معطل*\n *⌯⁞قناة سورس زورو ↓*\n".." *⌯⁞*[اضغط هنا لدخول](t.me/SOURCE_ZOROPLUS_plus) \n"
local NumFile = 0
...
local UserName = (b.username_ or "SOURCE_ZOROPLUS_plus")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯⁞العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..')'
status  = '\n*⌯⁞تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯⁞لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..')'
status  = '\n*⌯⁞تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯⁞اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯⁞العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯⁞اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_ZOROPLUS_plus')..')'..'\n*⌯⁞تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ZPRO PLUS', url="t.me/SOURCE_ZOROPLUS_plus"}},
...
keyboard.inline_keyboard = {
{
{text = 'ZPRO PLUS', url = "https://t.me/SOURCE_ZOROPLUS_plus"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZOROPLUS_plus')..')'
local iduser = result.sender_user_id_
...
*✫م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ ZOROPLUS ━━━━━━━•*ٴ
[ZOROPLUS PLUS](t.me/SOURCE_ZOROPLUS_plus) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = 'ZOROPLUS PLUS', url="t.me/SOURCE_ZOROPLUS_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
