...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DVZORO PLUS/Files_ZORO PLUS/main/File_Bot/commands.lua") 
...
function ZORO PLUSSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevZORO PLUSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local ZORO PLUS_Msg = ''  
if msgs < 100 then 
ZORO PLUS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ZORO PLUS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ZORO PLUS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ZORO PLUS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ZORO PLUS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ZORO PLUS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ZORO PLUS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ZORO PLUS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ZORO PLUS_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ZORO PLUS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ZORO PLUS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ZORO PLUS_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ZORO PLUS_Msg = 'رب التفاعل'  
end 
return ZORO PLUS_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceZORO PLUS(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."ZORO PLUS1:List:Filter"..sl)
...
if not DevZORO PLUSW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevZORO PLUSW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ZORO PLUS_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ྿' and DevZORO PLUSW(msg) then  
...
if text == 'تعطيل التواصل ྿' and DevZORO PLUSW(msg) then  
...
if text == 'تفعيل البوت الخدمي ྿' and DevZORO PLUSW(msg) then  
...
if text == 'تعطيل البوت الخدمي ྿' and DevZORO PLUSW(msg) then  
...
if text == 'ضع كليشه ستارت ྿' and DevZORO PLUSW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *𖣔ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ྿' and DevZORO PLUSW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *𖣔تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ྿' and DevZORO PLUSW(msg) then 
...
if text == 'تحديث السورس ྿' and DevZORO PLUSW(msg) then 
os.execute('rm -rf ZORO PLUS.lua')
...
if text == 'المشتركين ྿' and DevZORO PLUSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *𖣔المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ྿' and DevZORO PLUSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *𖣔الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ྿") and DevZORO PLUSW(msg) then
...
if text == ("قائمه الكتم العام ྿") and DevZORO PLUSW(msg) then
...
if text=="اذاعه خاص ྿" and msg.reply_to_message_id_ == 0 and DevZORO PLUSW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖣔ارسل الان اذاعتك؟* \n*𖣔للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ྿" and msg.reply_to_message_id_ == 0 and DevZORO PLUSW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖣔ارسل الان اذاعتك؟* \n*𖣔للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ྿" and msg.reply_to_message_id_ == 0 and DevZORO PLUSW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖣔ارسل الان اذاعتك؟* \n*𖣔للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ྿" and msg.reply_to_message_id_ == 0  and DevZORO PLUSW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖣔ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ྿" and msg.reply_to_message_id_ == 0  and DevZORO PLUSW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖣔ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ྿' and DevZORO PLUSW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ྿" and DevZORO PLUSW(msg) then
...
if text == "تنظيف الجروبات ྿" and DevZORO PLUSW(msg) then 
...
send(msg.chat_id_, msg.id_,'*𖣔عدد الجروبات الان » { '..#group..' }'..ZORO PLUSk..''..ZORO PLUS..'*\n*𖣔الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevZORO PLUSW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevZORO PLUSW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevZORO PLUSW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevZORO PLUSW(msg) then
...
local ZORO PLUS1_Msg = database:get(bot_id.."ZORO PLUS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZORO PLUS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if ZORO PLUS_Msg and not Special(msg) then  
local ZORO PLUS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ZORO PLUS_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevZORO PLUSW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevZORO PLUSW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevZORO PLUSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *𖣔حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevZORO PLUSW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *𖣔حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ྿" and DevZORO PLUSW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *𖣔تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ྿$") and DevZORO PLUSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *𖣔حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ྿" and DevZORO PLUSW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ྿" and DevZORO PLUSW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *𖣔تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ྿" and DevZORO PLUSW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."ZORO PLUS:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ZORO PLUS:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ZORO PLUS = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ZORO PLUS then 
names_ZORO PLUS = database:smembers(bot_id.."ZORO PLUS:blocname"..msg.chat_id_) or ""
if names_ZORO PLUS and names_ZORO PLUS[1] then 
for i=1,#names_ZORO PLUS do 
if name_ZORO PLUS:match("(.*)("..names_ZORO PLUS[i]..")(.*)") then 
...
database:set(bot_id.."ZORO PLUS:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ZORO PLUS:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ZORO PLUS:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ZORO PLUS:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ZORO PLUS:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ZORO PLUSa_new(ZORO PLUS1,ZORO PLUS2)
if ZORO PLUS2 and ZORO PLUS2.first_name_ then 
if ZORO PLUS2.first_name_:match("(.*)"..database:get(bot_id.."ZORO PLUS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZORO PLUS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ZORO PLUS_nnn = database:get(bot_id.."ZORO PLUS:nump"..msg.chat_id_) or 5
local ZORO PLUS_nnn2 = database:get(bot_id.."ZORO PLUS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ZORO PLUS_nnn2) == tonumber(ZORO PLUS_nnn) or tonumber(ZORO PLUS_nnn2) > tonumber(ZORO PLUS_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ZORO PLUS:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "𖣔عزيزي >>["..ZORO PLUS2.username_.."](https://t.me/"..(ZORO PLUS2.username_ or "SOURCE_ZORO_plus")..")\n𖣔عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZORO PLUS:teh"..msg.chat_id_).."} بجانب اسمك\n𖣔عدد المحاولات المتبقيه {"..(tonumber(ZORO PLUS_nnn) - tonumber(ZORO PLUS_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ZORO PLUSa_new)
end
end
...
local ZORO PLUSChengName = database:get(bot_id.."ZORO PLUS:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ZORO PLUSChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ZORO PLUSChengName..']')
database:del(bot_id.."ZORO PLUS:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ZORO PLUSChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ZORO PLUS:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ZORO PLUSChengUserName = database:get(bot_id.."ZORO PLUS:Cheng:UserName"..data.id_)
if not data.username_ then 
if ZORO PLUSChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ZORO PLUSChengUserName..']')
database:del(bot_id.."ZORO PLUS:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ZORO PLUSChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ZORO PLUS:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ZORO PLUSChengPhoto = database:get(bot_id.."ZORO PLUS:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ZORO PLUSChengPhoto then 
send(msg.chat_id_, msg.id_, "تم حذف جميع الصور")
database:del(bot_id.."ZORO PLUS:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ZORO PLUSChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ZORO PLUS:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevZORO PLUSW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevZORO PLUSW(msg) then
dofile('ZORO PLUS.lua')  
send(msg.chat_id_, msg.id_, ' *𖣔تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevZORO PLUSW(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n *𖣔تم مسح قائمه العام*')
return false
end
if text == ("قائمه العام") and DevZORO PLUSW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevZORO PLUSW(msg) then  
function start_function(extra, result, success)
if ZORO PLUSSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevZORO PLUSW(msg) then  
...
if ZORO PLUSSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*𖣔لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevZORO PLUSW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if ZORO PLUSSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*𖣔لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevZORO PLUSW(msg) then  
function start_function(extra, result, success)
if ZORO PLUSSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*𖣔لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevZORO PLUSW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevZORO PLUSW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if ZORO PLUSSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*𖣔لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevZORO PLUSW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevZORO PLUSW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevZORO PLUSW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevZORO PLUSW(msg) then
...
if text == 'الملفات' and DevZORO PLUSW(msg) then
...
if DevZORO PLUSW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DVZORO PLUS/Files_ZORO PLUS/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevZORO PLUSW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DVZORO PLUS/Files_ZORO PLUS/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevZORO PLUSW(msg) then
...
if text == "مسح الملفات" and DevZORO PLUSW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *𖣔تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevZORO PLUSW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevZORO PLUSW(msg) then  
function start_function(extra, result, success)
...
function Function_ZORO PLUS(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZORO PLUS, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ZORO PLUS, nil)
return false 
end
...
database:set(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *𖣔ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZORO PLUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZORO PLUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *𖣔تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZORO PLUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZORO PLUS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZORO PLUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *𖣔ارسل الكلمه الان*")  
database:set(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZORO PLUS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZORO PLUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ZORO PLUS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZORO PLUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZORO PLUS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZORO PLUS1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevZORO PLUSW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *𖣔تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevZORO PLUSW(msg) then
...
if text == 'تفعيل الاذاعه' and DevZORO PLUSW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevZORO PLUSW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..ZORO PLUS_Msg[math.random(#ZORO PLUS_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevZORO PLUSW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,ZORO PLUS)
local t = "\n*ツ قائمة الاعضاء* \n•━═━═━═━═━═━═━═━═━•\n"
x = 0
local list = ZORO PLUS.members_
for k, v in pairs(list) do
x = x + 1
...
if ZORO PLUSSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevZORO PLUSW(msg) then 
...
if text == ("ردود المطور") and DevZORO PLUSW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖣔قائمة ردود المطور \n•━═━═━═━═━═━═━═━═━•\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevZORO PLUSW(msg) then    
send(msg.chat_id_, msg.id_,' *𖣔ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد عام' and DevZORO PLUSW(msg) then    
...
if text == 'تفعيل المغادره' and DevZORO PLUSW(msg) then   
...
if text == 'تعطيل المغادره' and DevZORO PLUSW(msg) then  
...
if text == 'استعاده الاوامر' and DevZORO PLUSW(msg) then
...
{
{text = 'ZORO PLUS𝐬', callback_data="/help13"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
inline = {
{{text = 'ZORO PLUS',url='http://t.me/SOURCE_ZORO_plus'}},
}
...
ZORO PLUS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ZORO PLUS)
...
--------------------------------------------------------------------------------------------------------------
SourceZORO PLUS(data.message_,data)
...
------------------------------------------------------------------------
local ZORO PLUSAbot = database:get(bot_id.."ZORO PLUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZORO PLUSAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *𖣔العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n𖣔["..ZORO PLUSAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local ZORO PLUS1_Msg = database:get(bot_id.."ZORO PLUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZORO PLUS1_Msg then
send(msg.chat_id_, msg.id_," 𖣔"..ZORO PLUS1_Msg)
