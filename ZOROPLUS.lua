...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SourceZOROPLUSrVi/File_ZOROPLUSrVi/main/File_Bot/commands.lua") 
...
function ZOROPLUSrViSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
function AliZOROPLUSrViW(msg) 
local hash = database:sismember(bot_id.."Ali:Sudo:T", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROPLUSrViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Ali:Sudo:T", user_id) then
var = true  
...
local ZOROPLUSrVi_Msg = ''  
if msgs < 100 then 
ZOROPLUSrVi_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ZOROPLUSrVi_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ZOROPLUSrVi_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ZOROPLUSrVi_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ZOROPLUSrVi_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ZOROPLUSrVi_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ZOROPLUSrVi_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ZOROPLUSrVi_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ZOROPLUSrVi_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ZOROPLUSrVi_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ZOROPLUSrVi_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ZOROPLUSrVi_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ZOROPLUSrVi_Msg = 'رب التفاعل'  
end 
return ZOROPLUSrVi_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceZOROPLUSrVi(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if AliZOROPLUSrViW(msg) then
local bl = ' *⌯⁞اهلا عزيزي آلمـطـور*\n*⌯⁞آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*⌯⁞تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*⌯⁞من خلاال الكيبورت خاص بك*\n*⌯⁞قناة سورس البوت *[اضغط هنا](t.me/SOURCE_ZORO_plus)'
local keyboard = {
...
if start then 
SourceZOROPLUSrVir = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'زورو')
SourceZOROPLUSrVir = '*⌯⁞اهلا عزيزي*\n*⌯⁞انا بوت اسمي '..Namot..'*\n*⌯⁞اختصاصي حمايه الجروبات*\n*⌯⁞من تكرار والسبام والتوجيه والخ…*\n*⌯⁞لتفعيلي اتبع الاخطوات…↓*\n*⌯⁞اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⌯⁞[قناة سورس البوت](https://t.me/SOURCE_ZORO_plus)'
end
send(msg.chat_id_, msg.id_, SourceZOROPLUSrVir) 
end
end
...
local list = database:smembers(bot_id.."ZOROPLUSrVi1:List:Filter"..sl)
...
if not AliZOROPLUSrViW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if AliZOROPLUSrViW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ZOROPLUSrVi_Msg) 
return false  
end 
if text then
...
database:del(bot_id.."Ali:Sudo:T")
send(msg.chat_id_, msg.id_, "\n*⌯⁞تم مسح قائمة المطورين الثانويين* ")
end
if text == 'الثانويين ✫' and SudoBot(msg) then
local list = database:smembers(bot_id.."Ali:Sudo:T")
...
if text == 'تفعيل التواصل ✫' and AliZOROPLUSrViW(msg) then  
...
if text == 'تعطيل التواصل ✫' and AliZOROPLUSrViW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and AliZOROPLUSrViW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and AliZOROPLUSrViW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and AliZOROPLUSrViW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯⁞ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and AliZOROPLUSrViW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and AliZOROPLUSrViW(msg) then 
...
if database:get(bot_id.."Ed:AliBots") then
...
A:close()
database:del(bot_id.."Ed:AliBots")
dofile('ZOROPLUSrVi.lua')  
else
...
database:set(bot_id..'Ed:AliBots',true) 
end
if text =='تغيير المطور الاساسي ✫' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*⌯⁞لا يمكنك تغيير المطور الاساسي*')
end
if text == 'تحديث السورس ✫' and AliZOROPLUSrViW(msg) then 
os.execute('rm -rf ZOROPLUSrVi.lua')
os.execute('https://raw.githubusercontent.com/jokerrr7/ZPROPLUS/main/ZOROPLUSrVi.lua')
send(msg.chat_id_, msg.id_,' *⌯⁞تم تحديث السورس* \n*⌯⁞لديك اخر اصدار لسورس زورو*\n*⌯⁞الاصدار » { 2.8v}*')
dofile('ZOROPLUSrVi.lua')  
end
if text == 'الاصدار ✫' and AliZOROPLUSrViW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞اصدار سورس زورو* \n*⌯⁞الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and AliZOROPLUSrViW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯⁞[تحديثات البوت](t.me/SOURCE_ZORO_plus) \n⌯⁞[قناه السورس](t.me/SOURCE_ZORO_plus)')
end
if text == "ضع اسم للبوت ✫" and AliZOROPLUSrViW(msg) then  
...
{
{text = 'ZORO PLUS', url = "https://t.me/SOURCE_ZORO_plus"},
},
}
...
if text == 'المشتركين ✫' and AliZOROPLUSrViW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ✫' and AliZOROPLUSrViW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and AliZOROPLUSrViW(msg) then
...
if text == ("قائمه العام ✫") and AliZOROPLUSrViW(msg) then
...
if text == ("قائمه الكتم العام ✫") and AliZOROPLUSrViW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and AliZOROPLUSrViW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and AliZOROPLUSrViW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and AliZOROPLUSrViW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and AliZOROPLUSrViW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and AliZOROPLUSrViW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯⁞ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and AliZOROPLUSrViW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and AliZOROPLUSrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ✫" and AliZOROPLUSrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local ZOROPLUSrVi = (w + q)
local sendok = #group - ZOROPLUSrVi
if q == 0 then
ZOROPLUSrVi = ''
else
...
send(msg.chat_id_, msg.id_,'*⌯⁞عدد الجروبات الان » { '..#group..' }'..ZOROPLUSrVik..''..ZOROPLUSrVi..'*\n*⌯⁞الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and AliZOROPLUSrViW(msg) then
...
usertext = '*\n ⌯⁞اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SOURCE_ZORO_plus')..')'
status  = '\n *⌯⁞تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and AliZOROPLUSrViW(msg) then
...
usertext = '\n *⌯⁞اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'
status  = '\n*⌯⁞تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and AliZOROPLUSrViW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and AliZOROPLUSrViW(msg) then
...
local ZOROPLUSrVi1_Msg = database:get(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZOROPLUSrVi1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯⁞اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ZORO_plus')..') \n ⌯⁞'..ZOROPLUSrVi1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ZOROPLUSrVi_Msg and not Special(msg) then  
local ZOROPLUSrVi_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ZOROPLUSrVi_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯⁞["..ZOROPLUSrVi_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](t.me/SOURCE_ZORO_plus)}\n⌯⁞["..ZOROPLUSrVi_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯⁞عذرا ↫* {["..data.first_name_.."](t.me/SOURCE_ZORO_plus)}\n*⌯⁞عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not AliZOROPLUSrViW(msg) then
...
'\n *⌯⁞الرابط* {['..LinkGp..']}'
if not AliZOROPLUSrViW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and AliZOROPLUSrViW(msg) then
...
if text and text:match("^تغير الاشتراك$") and AliZOROPLUSrViW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and AliZOROPLUSrViW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and AliZOROPLUSrViW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯⁞تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and AliZOROPLUSrViW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and AliZOROPLUSrViW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and AliZOROPLUSrViW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯⁞تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and AliZOROPLUSrViW(msg) then  
...
local AMIRAli = database:get(bot_id.."AL:Sre:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"*حاله الاضافات هي : {"..AMIRAli.."}*\n*اذا كانت {✔} الاضافات مفعله*\n*اذا كانت {❌} الاضافات معطله*")
end
...
database:sadd(bot_id.."ZOROPLUSrVi:blocname"..msg.chat_id_, BlNe)
end
...
database:srem(bot_id.."ZOROPLUSrVi:blocname"..msg.chat_id_, delBn)
end

if text == "مسح الاسماء المكتومه" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
database:del(bot_id.."ZOROPLUSrVi:blocname"..msg.chat_id_)
...
local All_name = database:smembers(bot_id.."ZOROPLUSrVi:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ZOROPLUSrVi = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ZOROPLUSrVi then 
names_ZOROPLUSrVi = database:smembers(bot_id.."ZOROPLUSrVi:blocname"..msg.chat_id_) or ""
if names_ZOROPLUSrVi and names_ZOROPLUSrVi[1] then 
for i=1,#names_ZOROPLUSrVi do 
if name_ZOROPLUSrVi:match("(.*)("..names_ZOROPLUSrVi[i]..")(.*)") then 
...
database:set(bot_id.."ZOROPLUSrVi:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ZOROPLUSrVi:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ZOROPLUSrVi:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ZOROPLUSrVi:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ZOROPLUSrVi:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ZOROPLUSrVia_new(ZOROPLUSrVi1,ZOROPLUSrVi2)
if ZOROPLUSrVi2 and ZOROPLUSrVi2.first_name_ then 
if ZOROPLUSrVi2.first_name_:match("(.*)"..database:get(bot_id.."ZOROPLUSrVi:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZOROPLUSrVi:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ZOROPLUSrVi_nnn = database:get(bot_id.."ZOROPLUSrVi:nump"..msg.chat_id_) or 5
local ZOROPLUSrVi_nnn2 = database:get(bot_id.."ZOROPLUSrVi:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ZOROPLUSrVi_nnn2) == tonumber(ZOROPLUSrVi_nnn) or tonumber(ZOROPLUSrVi_nnn2) > tonumber(ZOROPLUSrVi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ZOROPLUSrVi:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯⁞عزيزي >>["..ZOROPLUSrVi2.username_.."](https://t.me/"..(ZOROPLUSrVi2.username_ or "SOURCE_ZORO_plus")..")\n⌯⁞عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZOROPLUSrVi:teh"..msg.chat_id_).."} بجانب اسمك\n⌯⁞عدد المحاولات المتبقيه {"..(tonumber(ZOROPLUSrVi_nnn) - tonumber(ZOROPLUSrVi_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ZOROPLUSrVia_new)
end
end
...
local ZOROPLUSrViChengName = database:get(bot_id.."ZOROPLUSrVi:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ZOROPLUSrViChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ZOROPLUSrViChengName..']')
database:del(bot_id.."ZOROPLUSrVi:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ZOROPLUSrViChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ZOROPLUSrVi:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ZOROPLUSrViChengUserName = database:get(bot_id.."ZOROPLUSrVi:Cheng:UserName"..data.id_)
if not data.username_ then 
if ZOROPLUSrViChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ZOROPLUSrViChengUserName..']')
database:del(bot_id.."ZOROPLUSrVi:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ZOROPLUSrViChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ZOROPLUSrVi:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ZOROPLUSrViChengPhoto = database:get(bot_id.."ZOROPLUSrVi:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ZOROPLUSrViChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ZOROPLUSrVi:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ZOROPLUSrViChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ZOROPLUSrVi:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('http://sofarr.ml/ASHTRAKLUA/amar.php?id='..msg.sender_user_id_) 
data = JSON.decode(url) 
if data.Ch_Member.info ~= true then 
send(msg.chat_id_,msg.id_,'⌯⁞شترك في قناة السورس اولآ @SOURCE_ZORO_plus.') 
return false 
end 
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ᴢᴏʀᴏ ᴘʟụѕ\n\n[✫  ᴢᴏʀᴏ ᴘʟụѕ ᴄʜᴀɴɴᴇʟ](http://t.me/SOURCE_ZORO_plus)\n\n[✫ ᴄʜᴀɴɴᴇʟ](https://t.me/joinchat/g-ydeDBrho4xNmE0)\n\n[✫ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/Bahjat100)\n\n[✫ ʙᴏᴛ ᴢᴏʀᴏ ᴘʟụѕ](http://t.me/Bahjat111_bot)" 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✫ ѕᴏụʀᴄᴇ ᴢᴏʀᴏ ᴘʟụѕ',url="t.me/SOURCE_ZORO_plus"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'رفع نسخه الاحتياطيه' and AliZOROPLUSrViW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, '*⌯⁞بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ZORO_plus')..') \n*⌯⁞تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯⁞بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_ZORO_plus')..') \n*⌯⁞تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and AliZOROPLUSrViW(msg) then
dofile('ZOROPLUSrVi.lua')  
send(msg.chat_id_, msg.id_, ' *⌯⁞تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and AliZOROPLUSrViW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and AliZOROPLUSrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if ZOROPLUSrViSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and AliZOROPLUSrViW(msg) then
...
if ZOROPLUSrViSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯⁞لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and AliZOROPLUSrViW(msg) then
...
if ZOROPLUSrViSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯⁞لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and AliZOROPLUSrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and AliZOROPLUSrViW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and AliZOROPLUSrViW(msg) then
...
if ZOROPLUSrViSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯⁞لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and AliZOROPLUSrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and AliZOROPLUSrViW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and AliZOROPLUSrViW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and AliZOROPLUSrViW(msg) then
...
if text == 'الملفات' and AliZOROPLUSrViW(msg) then
t = ' *⌯⁞ملفات السورس زورو ↓*\n*•━━━ ZOROPLUS ━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if AliZOROPLUSrViW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceZOROPLUSrVi/File_ZOROPLUSrVi/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯⁞اهلا بك في متجر ملفات زورو*\n*⌯⁞ملفات السورس ↓*\n*•━━━ ZOROPLUS ━━━•*\n\n"
local TextE = "\n*•━━━ ZOROPLUS ━━━•*\n *⌯⁞علامة تعني { ✓ } ملف مفعل*\n *⌯⁞علامة تعني { ✘ } ملف معطل*\n *⌯⁞قناة سورس زورو ↓*\n".." *⌯⁞*[اضغط هنا لدخول](t.me/SOURCE_ZORO_plus) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and AliZOROPLUSrViW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceZOROPLUSrVi/File_ZOROPLUSrVi/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ZOROPLUSrVi.lua')  
else
send(msg.chat_id_, msg.id_," *⌯⁞عذرا الملف لايدعم سورس زورو* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and AliZOROPLUSrViW(msg) then
...
if text == "مسح الملفات" and AliZOROPLUSrViW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯⁞تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and AliZOROPLUSrViW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and AliZOROPLUSrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_ZOROPLUSrVi(extra, result, success)
database:sadd(bot_id.."Ali:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⌯⁞تم ترقيته مطور ثانوي في البوت*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZOROPLUSrVi, nil)
return false 
end
...
function Function_ZOROPLUSrVi(extra, result, success)
database:srem(bot_id.."Ali:Sudo:T", result.sender_user_id_)
...
function Function_ZOROPLUSrVi(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ali:Sudo:T", result.id_)
...
database:srem(bot_id.."Ali:Sudo:T", userid)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯⁞لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'
status  = '\n*⌯⁞تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯⁞اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯⁞اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'AliBESSO')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯⁞العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'AliBESSO')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯⁞العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯⁞العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'
status  = '\n*⌯⁞تم تنزيل العضــو الحات من الجروب*\n*⌯⁞مشيي مو خوش حات*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
{{text ='ZORO PLUS', url="t.me/BLACK_TEAM_4"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯⁞ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZOROPLUSrVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZOROPLUSrVi1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯⁞تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZOROPLUSrVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZOROPLUSrVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الكلمه الان*")  
database:set(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZOROPLUSrVi1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ZOROPLUSrVi1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZOROPLUSrVi1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and AliZOROPLUSrViW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯⁞تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and AliZOROPLUSrViW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯⁞اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_ZORO_plus')..')'..'\n*⌯⁞تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and AliZOROPLUSrViW(msg) then  
...
if text == 'تعطيل الاذاعه' and AliZOROPLUSrViW(msg) then  
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) > 0 and not database:get(bot_id..'ZOROPLUS:Lock:ID:Bot'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'ZOROPLUS:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."ZOROPLUS:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'ZOROPLUS:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."ZOROPLUS:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
local texte = '\n*▹ |ايديك  . '..Id..'\n▹ | معرفك  .* ['..UserName_User..']*\n▹ |رتبتك  . '..Status_Gps..'\n▹ | رسائلك  . '..NumMsg..' \n▹ | التفاعل . '..TotalMsg..'\n▹ |الالعاب  . '..Num_Games..'*'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'ZOROPLUS:Lock:ID:Bot'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,'['..ZOROPLUSrVi_Msg[math.random(#ZOROPLUSrVi_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not AliZOROPLUSrViW(msg) then 
...
},function(ta,ZOROPLUSrVi)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━ ZOROPLUS ━━━•*\n"
x = 0
local list = ZOROPLUSrVi.members_
for k, v in pairs(list) do
x = x + 1
...
if ZOROPLUSrViSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'Ali:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Ali:Sudo:T',msg.sender_user_id_) then
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and AliZOROPLUSrViW(msg) then 
...
if text == ("ردود المطور") and AliZOROPLUSrViW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯⁞قائمة ردود المطور \n*•━━━ ZOROPLUS ━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and AliZOROPLUSrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and AliZOROPLUSrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and AliZOROPLUSrViW(msg) then   
...
if text == 'تعطيل المغادره' and AliZOROPLUSrViW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯⁞ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOROPLUSrViFiles')..') '
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'ZOROPLUS:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'ZOROPLUS:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."ZOROPLUS:Spam:Group"..msg.sender_user_id_,text) 
...
local NumMsg = database:get(bot_id..'ZOROPLUS:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."ZOROPLUS:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'ZOROPLUS:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."ZOROPLUS:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."ZOROPLUS:Klesh:Id:Bot"..msg.chat_id_) or database:get(bot_id.."ZOROPLUS:KleshIDALLBOT")
if not database:get(bot_id..'ZOROPLUS:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
-- vardump(data) 
ZOROPLUSrVidx(msg.chat_id_, msg.id_, ' *⌯⁞ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯⁞عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯⁞عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯⁞عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and AliZOROPLUSrViW(msg) then
...
*✫م10 ◂ اوامر الاعضاء*
ٴ*•━━━ ZOROPLUS ━━━•*ٴ
[ZORO PLUS](t.me/SOURCE_ZORO_plus) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = 'ZORO PLUS', url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━ ZOROPLUS ━━━•*ٴ✫∫○ٴ\n⌯⁞[ZORO PLUS](t.me/SOURCE_ZORO_plus) ')
end
...
send(msg.chat_id_, msg.id_,'𖡼⤈  لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end
if Text == '/ven2' then
...
ZOROPLUSrVi = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ZOROPLUSrVi)
...
--------------------------------------------------------------------------------------------------------------
SourceZOROPLUSrVi(data.message_,data)
...
------------------------------------------------------------------------
local ZOROPLUSrViAbot = database:get(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOROPLUSrViAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯⁞["..ZOROPLUSrViAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local ZOROPLUSrVi1_Msg = database:get(bot_id.."ZOROPLUSrVi1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOROPLUSrVi1_Msg then
send(msg.chat_id_, msg.id_," ⌯⁞"..ZOROPLUSrVi1_Msg)
