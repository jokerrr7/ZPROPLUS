...
--------------------------------------------------------------------------------------------------------------
function SourceZPROPLUS(msg,data) -- بداية العمل جوکر الـ دلـيـم
if msg then
...
local keyboard = {
{'الاحصائيات 𖣔','قناه تحديثات السورس والبوت 𖣔'},
...
if text == 'معلومات السيرفر 𖣔' DevGOLDW(msg) then 
...
if text == 'قناه تحديثات السورس والبوت 𖣔' then 
local Text = [[ 
Source channel
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه تحديثات السورس والبوت 𖣔', url="t.me/SOURCE_ZORO_plus"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bahjat78/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'الاحصائيات 𖣔' and Sudo(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'زورو') 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Namebot = "𖡼احصائيات بوت » "..Namebot..'\n𖡼عدد المجموعات » {'..Groups..'}\n𖡼عدد المشتركين » {'..Users..'}'
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'المشتركين 𖣔' and DevGOLDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *𖡼المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات 𖣔' and DevGOLDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *𖡼الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
{
{text = 'DEVEIOPERS', callback_data="/help30"},{text = 'CHANNEI', callback_data="/help31"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bahjat78/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Namebot = "𖡼 احصائيات بوت » "..Namebot..'\n𖡼عدد المجموعات » {'..Groups..'}\n𖡼عدد المشتركين » {'..Users..'}'
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "رتبتي" then
local msg_id = msg.id_/2097152/0.5  
local textt = ' 𖡼 رتبتك '..Rutba(msg.sender_user_id_,msg.chat_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local msg_id = msg.id_/2097152/0.5  
local textt = ' 𖡼 انت '..Rutba(msg.sender_user_id_,msg.chat_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ZPRO PLUS', url = "https://t.me/SOURCE_ZORO_plus"},
...
function start_function(extra, result, success)
send(msg.chat_id_, msg.id_,'*𖡼 لقبه هو :* '..getcustom(msg,result)) 
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
if text == 'لقبي' and tonumber(msg.reply_to_message_id_) == 0 then
send(msg.chat_id_, msg.id_,'*𖡼 لقبك هو :* '..getcustom(msg,msg)) 
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = '𖡼اسمك الاول » {*`'..(result.first_name_)..'`*}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' *𖡼اسمك الثاني »* {*`'..result.last_name_..'`*}' 
else
last_name = ''
end  
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' *𖡼ايديك »* '..msg.sender_user_id_)
end
...
if text == 'الابراج' then
local Text = [[
𖡼اهلا بك عزيزي اختر برجك ⍖ .
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'برج الدلو 𖡼', callback_data="/help22"},{text = 'برج الثور 𖡼', callback_data="/help21"},{text = 'برج الاسد 𖡼', callback_data="/help24"},
},
{
{text = 'برج العذراء 𖡼', callback_data="/help25"},{text = 'برج السرطان 𖡼', callback_data="/help23"},
},
{
{text = 'برج القوس 𖡼', callback_data="/help28"},{text = 'برج العقرب 𖡼', callback_data="/help27"},
},
{
{text = 'برج الميزان 𖡼', callback_data="/help26"},{text = 'برج الجوزاء 𖡼', callback_data="/help20"},
},
{
{text = 'برج الحوت 𖡼', callback_data="/help31"},{text = 'برج الحمل 𖡼', callback_data="/help30"},{text = 'برج الجدي 𖡼', callback_data="/help29"},
},
{
{text = 'ZORO PLUS', url = "https://t.me/SOURCE_ZORO_plus"}
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ZPROPLUS', url="t.me/SOURCE_ZORO_plus"}},
