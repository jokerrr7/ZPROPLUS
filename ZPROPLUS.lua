...
os.execute('wget https://raw.githubusercontent.com/ZPROPLUS/ZPROPLUS/master/ZPROPLUS.lua')
...
local Text = [[
Welcome To Source
 𖢵 [ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴢᴏʀᴏ](https://t.me/SOURCE_ZORO_plus)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == "بوت" then
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'زورو') 
local ZPROPLUS_Msg = { 
'اسمي  '..Namebot..' يا قلبي ',
'اسمي '..Namebot..' يا روحي',
'اسمي  '..Namebot..' يعمري',
'اسمي  '..Namebot..' يا قمر',
'اسمي  '..Namebot..' يا قمري ',
'اسمي  '..Namebot..' يعم ',
...
Namebot = ZPROPLUS_Msg[math.random(#ZPROPLUS_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'رتبتي' then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,' *𖣔︙رتبتك في البوت »* '..rtp)
end
...
first_name = ' *𖣔︙اسمك الاول »* {*`'..(result.first_name_)..'`*}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' *𖣔︙اسمك الثاني »* {*`'..result.last_name_..'`*}' 
else
last_name = ''
end  
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' *𖣔︙ايديك »* '..msg.sender_user_id_)
end
