...
SUDO = SUDO
sudo_users = {SUDO,1754239041,772538035}   
print([[
> CH › @SOURCE_ZORO_plus
> CH › @SourceJarVi
~> AliELOPER › @nnzzz
...
--------------------------------------------------------------------------------------------------------------
function SourceJarVi(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."JarVi1:List:Filter"..sl)
...
if not AliJarViW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if AliJarViW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,JarVi_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✫' and AliJarViW(msg) then  
...
if text == 'تعطيل التواصل ✫' and AliJarViW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and AliJarViW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and AliJarViW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and AliJarViW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯⁞ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and AliJarViW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and AliJarViW(msg) then 
...
os.execute('https://raw.githubusercontent.com/jokerrr7/ZPROPLUS/main/JarVi.lua')
...
if text == "ضع اسم للبوت ✫" and AliJarViW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and AliJarViW(msg) then 
...
if text == 'المشتركين ✫' and AliJarViW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and AliJarViW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and AliJarViW(msg) then
...
if text == ("قائمه العام ✫") and AliJarViW(msg) then
...
if text == ("قائمه الكتم العام ✫") and AliJarViW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and AliJarViW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and AliJarViW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and AliJarViW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and AliJarViW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and AliJarViW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯⁞ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and AliJarViW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and AliJarViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and AliJarViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯⁞عدد الكروبات الان » { '..#group..' }'..JarVik..''..JarVi..'*\n*⌯⁞الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and AliJarViW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and AliJarViW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and AliJarViW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and AliJarViW(msg) then
...
local JarVi1_Msg = database:get(bot_id.."JarVi1:Add:Filter:Rp2"..text..msg.chat_id_)   
if JarVi1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if JarVi_Msg and not Special(msg) then  
local JarVi_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if JarVi_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not AliJarViW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and AliJarViW(msg) then
...
if text and text:match("^تغير الاشتراك$") and AliJarViW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and AliJarViW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and AliJarViW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯⁞تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and AliJarViW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and AliJarViW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and AliJarViW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯⁞تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and AliJarViW(msg) then  
...
database:sadd(bot_id.."JarVi:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."JarVi:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_JarVi = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_JarVi then 
names_JarVi = database:smembers(bot_id.."JarVi:blocname"..msg.chat_id_) or ""
if names_JarVi and names_JarVi[1] then 
for i=1,#names_JarVi do 
if name_JarVi:match("(.*)("..names_JarVi[i]..")(.*)") then 
...
database:set(bot_id.."JarVi:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."JarVi:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."JarVi:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."JarVi:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."JarVi:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_JarVia_new(JarVi1,JarVi2)
if JarVi2 and JarVi2.first_name_ then 
if JarVi2.first_name_:match("(.*)"..database:get(bot_id.."JarVi:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."JarVi:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local JarVi_nnn = database:get(bot_id.."JarVi:nump"..msg.chat_id_) or 5
local JarVi_nnn2 = database:get(bot_id.."JarVi:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(JarVi_nnn2) == tonumber(JarVi_nnn) or tonumber(JarVi_nnn2) > tonumber(JarVi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."JarVi:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯⁞عزيزي >>["..JarVi2.username_.."](https://t.me/"..(JarVi2.username_ or "XUaXU")..")\n⌯⁞عليك وضع التوحيد ⪼ {"..database:get(bot_id.."JarVi:teh"..msg.chat_id_).."} بجانب اسمك\n⌯⁞عدد المحاولات المتبقيه {"..(tonumber(JarVi_nnn) - tonumber(JarVi_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_JarVia_new)
end
end
...
local JarViChengName = database:get(bot_id.."JarVi:Cheng:Name"..data.id_)
if not data.first_name_ then 
if JarViChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..JarViChengName..']')
database:del(bot_id.."JarVi:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if JarViChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."JarVi:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local JarViChengUserName = database:get(bot_id.."JarVi:Cheng:UserName"..data.id_)
if not data.username_ then 
if JarViChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..JarViChengUserName..']')
database:del(bot_id.."JarVi:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if JarViChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."JarVi:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local JarViChengPhoto = database:get(bot_id.."JarVi:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if JarViChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."JarVi:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if JarViChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."JarVi:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and AliJarViW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and AliJarViW(msg) then
dofile('JarVi.lua')  
send(msg.chat_id_, msg.id_, ' *⌯⁞تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and AliJarViW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and AliJarViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if JarViSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and AliJarViW(msg) then
...
if JarViSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯⁞لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and AliJarViW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and AliJarViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and AliJarViW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and AliJarViW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and AliJarViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and AliJarViW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and AliJarViW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and AliJarViW(msg) then
...
if AliJarViW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceJarVi/File_JarVi/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and AliJarViW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceJarVi/File_JarVi/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and AliJarViW(msg) then
...
if text == "مسح الملفات" and AliJarViW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯⁞تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and AliJarViW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and AliJarViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_JarVi(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_JarVi, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_JarVi, nil)
return false 
end
...
database:set(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯⁞ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."JarVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."JarVi1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯⁞تم منع الكلمه مع التحذير*")  
database:del(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."JarVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."JarVi1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."JarVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الكلمه الان*")  
database:set(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."JarVi1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."JarVi1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."JarVi1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."JarVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."JarVi1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."JarVi1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and AliJarViW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯⁞تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and AliJarViW(msg) then
...
if text == 'تفعيل الاذاعه' and AliJarViW(msg) then  
...
if text == 'تعطيل الاذاعه' and AliJarViW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..JarVi_Msg[math.random(#JarVi_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not AliJarViW(msg) then 
...
if JarViSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'Ali:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and AliJarViW(msg) then 
...
if text == ("ردود المطور") and AliJarViW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯⁞قائمة ردود المطور \n*•━━━━━━ Ja ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and AliJarViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and AliJarViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and AliJarViW(msg) then   
...
if text == 'تعطيل المغادره' and AliJarViW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯⁞ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'JarViFiles')..') '
...
-- vardump(data) 
JarVidx(msg.chat_id_, msg.id_, ' *⌯⁞ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯⁞عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯⁞عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯⁞عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and AliJarViW(msg) then
...
*✫م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ Ja ━━━━━━━•*ٴ
[𝗝𝗮𝗿𝗩𝗶 : 𝗧𝗲𝗮𝗠](t.me/SOURCE_ZORO_plus) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𝗝𝗮𝗿𝗩𝗶 : 𝗧𝗲𝗮𝗠', url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━━━━ Ja ━━━━━━━•*ٴ✫∫○ٴ\n⌯⁞[𝗝𝗮𝗿𝗩𝗶 : 𝗧𝗲𝗮𝗠](t.me/SOURCE_ZORO_plus) ')
end
...
{{text = '𝗝𝗮𝗿𝗩𝗶 : 𝗧𝗲𝗮𝗠',url='https://t.me/SOURCE_ZORO_plus'}},
}
...
JarVi = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(JarVi)
...
--------------------------------------------------------------------------------------------------------------
SourceJarVi(data.message_,data)
...
------------------------------------------------------------------------
local JarViAbot = database:get(bot_id.."JarVi1:Add:Filter:Rp2"..text..result.chat_id_)   
if JarViAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯⁞["..JarViAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local JarVi1_Msg = database:get(bot_id.."JarVi1:Add:Filter:Rp2"..text..result.chat_id_)   
if JarVi1_Msg then
send(msg.chat_id_, msg.id_," ⌯⁞"..JarVi1_Msg)
