...
local RunBot = io.open("ZOROPLUS", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/ZOROPLUS
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr ZOROPLUS.lua
wget "https://raw.githubusercontent.com/jokerrr7/ZPROPLUS/main/ZOROPLUS.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./ZOROPLUS.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S ZOROPLUS -X kill
screen -S ZOROPLUS ./ZOROPLUS
done
]])
RunTs:close()
end
