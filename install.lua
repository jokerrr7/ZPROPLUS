...
local RunBot = io.open("JarVi", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/JarVi
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr JarVi.lua
wget "https://raw.githubusercontent.com/SourceJarVi/JarVi/main/JarVi.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./JarVi.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S JarVi -X kill
screen -S JarVi ./JarVi
done
]])
RunTs:close()
end
