...
local RunBot = io.open("ZPROPLUS", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/ZPROPLUS
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr ZPROPLUS
wget "https://raw.githubusercontent.com/ZPROPLUS/ZPROPLUS/master/ZPROPLUS.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./ZPROPLUS.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S ZPROPLUS -X kill
screen -S ZPROPLUS ./ZPROPLUS
done
]])
RunTs:close()
end
