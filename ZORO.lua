...
SUDO = SUDO
sudo_users = {SUDO,1765160742,1003237899}   
print([[
> CH › @SOURCE_ZORO_plus
> CH › @SourceJarVi
~> AliELOPER › @nnzzz
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SourceJarVi/File_JarVi/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or AliJarViW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliJarViW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliJarViW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or AliJarViW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliJarViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliJarViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliJarViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local JarVi_Msg = ''  
if msgs < 100 then 
JarVi_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
JarVi_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
JarVi_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
JarVi_Msg = 'متفاعل' 
elseif msgs < 1200 then 
JarVi_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
JarVi_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
JarVi_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
JarVi_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
JarVi_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
JarVi_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
JarVi_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
JarVi_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
JarVi_Msg = 'رب التفاعل'  
end 
return JarVi_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceZORO(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."ZORO1:List:Filter"..sl)
...
if not DevZOROW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevZOROW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ZORO_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✫' and DevZOROW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevZOROW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevZOROW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevZOROW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevZOROW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✫ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevZOROW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✫تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and DevZOROW(msg) then 
...
if text == 'تحديث السورس ✫' and DevZOROW(msg) then 
os.execute('rm -rf ZORO.lua')
os.execute('wget https://raw.githubusercontent.com/AMRELHAKER/ZORO/main/ZORO.lua')
send(msg.chat_id_, msg.id_,' *✫تم تحديث السورس* \n*✫لديك اخر اصدار لسورس زورو بلص*\n*✫الاصدار »{ 5.v}*')
dofile('ZORO.lua')  
end
if text == 'الاصدار ✫' and DevZOROW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✫اصدار سورس زورو بلص* \n*✫الاصدار »{ 4.v}*')
end
if text == 'قناه تحديثاhت البوت ✫' and DevZOROW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫[تحديثات البوت](t.me/SOURCE_ZORO_plus) \n✫[قناه السورس](t.me/SOURCE_ZORO_plus)')
end
if text == "ضع اسم للبوت ✫" and DevZOROW(msg) then  
...
if text == 'المشتركين ✫' and DevZOROW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ✫' and DevZOROW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and DevZOROW(msg) then
...
if text == ("قائمه الكتم العام ✫") and DevZOROW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevZOROW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫ارسل الان اذاعتك؟* \n*✫للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevZOROW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫ارسل الان اذاعتك؟* \n*✫للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevZOROW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫ارسل الان اذاعتك؟* \n*✫للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevZOROW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevZOROW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and DevZOROW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and DevZOROW(msg) then
...
if text == "تنظيف الجروبات ✫" and DevZOROW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✫عدد الجروبات الان » { '..#group..' }'..ZOROk..''..ZORO..'*\n*✫الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevZOROW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevZOROW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevZOROW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevZOROW(msg) then
...
local ZORO1_Msg = database:get(bot_id.."ZORO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZORO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if ZORO_Msg and not Special(msg) then  
local ZORO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ZORO_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevZOROW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevZOROW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevZOROW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevZOROW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevZOROW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✫تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevZOROW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevZOROW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevZOROW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✫تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevZOROW(msg) then  
...
database:sadd(bot_id.."ZORO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ZORO:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ZORO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ZORO then 
names_ZORO = database:smembers(bot_id.."ZORO:blocname"..msg.chat_id_) or ""
if names_ZORO and names_ZORO[1] then 
for i=1,#names_ZORO do 
if name_ZORO:match("(.*)("..names_ZORO[i]..")(.*)") then 
...
database:set(bot_id.."ZORO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ZORO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ZORO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ZORO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ZORO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ZOROa_new(ZORO1,ZORO2)
if ZORO2 and ZORO2.first_name_ then 
if ZORO2.first_name_:match("(.*)"..database:get(bot_id.."ZORO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZORO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ZORO_nnn = database:get(bot_id.."ZORO:nump"..msg.chat_id_) or 5
local ZORO_nnn2 = database:get(bot_id.."ZORO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ZORO_nnn2) == tonumber(ZORO_nnn) or tonumber(ZORO_nnn2) > tonumber(ZORO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ZORO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫عزيزي >>["..ZORO2.username_.."](https://t.me/"..(ZORO2.username_ or "SOURCE_ZORO_plus")..")\n✫عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZORO:teh"..msg.chat_id_).."} بجانب اسمك\n✫عدد المحاولات المتبقيه {"..(tonumber(ZORO_nnn) - tonumber(ZORO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ZOROa_new)
end
end
...
local ZOROChengName = database:get(bot_id.."ZORO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ZOROChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ZOROChengName..']')
database:del(bot_id.."ZORO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ZOROChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ZORO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ZOROChengUserName = database:get(bot_id.."ZORO:Cheng:UserName"..data.id_)
if not data.username_ then 
if ZOROChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ZOROChengUserName..']')
database:del(bot_id.."ZORO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ZOROChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ZORO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ZOROChengPhoto = database:get(bot_id.."ZORO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ZOROChengPhoto then 
send(msg.chat_id_, msg.id_, "جافا الهكر قد حذف كل الصور😂🙂")
database:del(bot_id.."ZORO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ZOROChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ZORO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevZOROW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevZOROW(msg) then
dofile('ZORO.lua')  
send(msg.chat_id_, msg.id_, ' *✫تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevZOROW(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n *✫تم مسح قائمه العام*')
return false
end
if text == ("قائمه العام") and DevZOROW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevZOROW(msg) then  
function start_function(extra, result, success)
if ZOROSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevZOROW(msg) then  
...
if ZOROSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✫لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevZOROW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if ZOROSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✫لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevZOROW(msg) then  
function start_function(extra, result, success)
if ZOROSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✫لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevZOROW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevZOROW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if ZOROSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✫لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevZOROW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevZOROW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevZOROW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevZOROW(msg) then
...
if text == 'الملفات' and DevZOROW(msg) then
t = ' *✫ملفات السورس زورو بلص ↓*\n•━═━═━═━═━═━═━═━═━• \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevZOROW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DVZORO/Files_ZORO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✫اهلا بك في متجر ملفات زورو بلص*\n*✫ملفات السورس ↓*\n•━═━═━═━═━═━═━═━═━•\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevZOROW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DVZORO/Files_ZORO/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ZORO.lua')  
else
send(msg.chat_id_, msg.id_," *✫عذرا الملف لايدعم سورس زورو بلص* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevZOROW(msg) then
...
if text == "مسح الملفات" and DevZOROW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✫تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevZOROW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevZOROW(msg) then  
function start_function(extra, result, success)
...
function Function_ZORO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZORO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ZORO, nil)
return false 
end
...
{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ', url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZORO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZORO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZORO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZORO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZORO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✫ارسل الكلمه الان*")  
database:set(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZORO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZORO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ZORO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZORO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZORO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZORO1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevZOROW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✫تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevZOROW(msg) then
...
if text == 'تفعيل الاذاعه' and DevZOROW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevZOROW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..ZORO_Msg[math.random(#ZORO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevZOROW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,ZORO)
local t = "\n*ツ قائمة الاعضاء* \n•━═━═━═━═━═━═━═━═━•\n"
x = 0
local list = ZORO.members_
for k, v in pairs(list) do
x = x + 1
...
if ZOROSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevZOROW(msg) then 
...
if text == ("ردود المطور") and DevZOROW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✫قائمة ردود المطور \n•━═━═━═━═━═━═━═━═━•\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevZOROW(msg) then    
send(msg.chat_id_, msg.id_,' *✫ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد عام' and DevZOROW(msg) then    
...
if text == 'تفعيل المغادره' and DevZOROW(msg) then   
...
if text == 'تعطيل المغادره' and DevZOROW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✫العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'T_aLeN')..') '
...
-- vardump(data) 
ZOROdx(msg.chat_id_, msg.id_, ' *✫ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✫عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✫عدد المحظورين » ( '..data.kicked_count_..' )*\n*✫عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevZOROW(msg) then
...
{{text = 'قناه السورس ☑️.', url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == '✫ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐆𝐨𝐥𝐝 ✫' then
local Text = [[
◈╢ اهلا بك في قسم مطورين السورس
◈╢ اختر ما تريد معرفته من الاسفل
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐃𝐞𝐯 𝐆𝐨𝐥𝐝', callback_data="/help12"},{text = '𝐓𝐰𝐚𝐬𝐨𝐥', callback_data="/help11"},
},
{
...
{
{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ', url = "https://t.me/SOURCE_ZORO_plus"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'•━═━═━═━═━═━═━═━═━•\n✫[قناه السورس ☑️.](t.me/SOURCE_ZORO_plus) ')
end
...
if text == 'احمد' or text == 'المصري' or text == 'مصري' or text == '✫ احــمــد ✫' or text == 'روح العتتالمي' then
local Text =[[
𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝 𝐄𝐥𝐦𝐚𝐬𝐫𝐲
]]
keyboard = {} 
...
{
{text = '𝗔𝗵𝗺𝗲𝗱', url = "https://t.me/Dev_Ah8"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐆𝐨𝐥𝐝',url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جافا' or text == 'عمرو' or text == 'مبرمج السورس' or text == '✫ جـــــافـــــا ✫' or text == 'قلب العالمي' then
local Text =[[
𝐉.𝐚.𝐯.𝐚.!🇨🇼
]]
keyboard = {} 
...
{
{text = 'ᯓ˹ ᴊᴀᴠᴀ ᴇʟʜᴀᴋᴇʀ˼𖠱', url = "https://t.me/UU_AK"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/30&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text ='تم اختيار البروفايل لك❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐆𝐨𝐥𝐝',url="t.me/SOURCE_ZORO_plus"}},
} 
...
if text == 'بيلي' or text == 'عامرو' or text == 'مبرمجا السورس' or text == '✫ جـــاــافـــــا ✫' or text == 'روح العتتالمي' then
local Text =[[
↝𝐏.𝐄.𝐋.𝐄 ✹🇦🇺
]]
keyboard = {} 
...
{
{text = '↝𝐏.𝐄.𝐋.𝐄 ✹🇦🇺', url = "https://t.me/ph_7v"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ph_7v&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'مبرمجين السورس' or text == 'مطورين السورس' or text == 'التسنن' then
local Text = [[
ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ɢᴏʟᴅ.
•––––––––☆–––––––•
ᴄʜᴀɴɴᴇʟ ᴅᴇᴠᴇʟᴏᴘᴇʀs ɢᴏʟᴅ.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝖦𝗈𝗅𝖽.',url="t.me/Dv_ZORO"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'عبدو' or text == 'عبدالله' or text == 'عبده' then
local Text = [[
ᯓ𝗔 𝗯 𝗱 𝗼.༆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᗪᗴᐯ ᗩᗷᗪO',url="t.me/DV_ABDO"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ', url="t.me/SOURCE_ZORO_plus"}},}
...
local Teext =[[
◈╢ اهلا بك في قسم التواصل
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐆𝐫𝐨𝐮𝐩', url="t.me/CT_Gold"},{text = '𝐁𝐨𝐭 𝐓𝐰𝐚𝐬𝐨𝐥', url="t.me/Ak85_bot"}},
{{text = '𝐂𝐡. 𝐃𝐞𝐯 𝐆𝐨𝐥𝐝', url="t.me/DV_ZORO"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐉𝐚𝐯𝐚.', url="t.me/UU_AK0"},{text = '𝐀𝐡.𝐄𝐥𝐦𝐚𝐬𝐫𝐲', url="t.me/DEV_AH8"}},
{{text = '𝐏𝐞𝐥𝐞', url="t.me/ph_7v"},{text = '𝐃𝐞𝐯 𝐀𝐛𝐝𝐨', url="t.me/DV_ABDO"}},
{{text = 'رجوع ➥', callback_data="/help14"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
◈╢ اهلا بك هذه قنوات تيم زورو بلص
◈╢ اصغط بالاسفل للوصول
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url="t.me/SOURCE_ZORO_plus"},{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝟐', url="t.me/SOURCE_ZORO_plus"}},
{{text = 'رجوع ➥', callback_data="/help14"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
inline = {
{{text = '🄲🄷 🄶🄾🄻🄳',url='http://t.me/SOURCE_ZORO_plus'}},
}
...
ZORO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ZORO)
...
------------------------------------------------------------------------
local ZOROAbot = database:get(bot_id.."ZORO1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOROAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫["..ZOROAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ZORO1_Msg = database:get(bot_id.."ZORO1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZORO1_Msg then
send(msg.chat_id_, msg.id_," ✫"..ZORO1_Msg)
