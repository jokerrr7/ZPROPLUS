...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SourceZOROrVi/File_ZOROrVi/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or AliZOROrViW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local ZOROrVi_Msg = ''  
if msgs < 100 then 
ZOROrVi_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ZOROrVi_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ZOROrVi_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ZOROrVi_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ZOROrVi_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ZOROrVi_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ZOROrVi_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ZOROrVi_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ZOROrVi_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ZOROrVi_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ZOROrVi_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ZOROrVi_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ZOROrVi_Msg = 'رب التفاعل'  
end 
return ZOROrVi_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceZOROrVi(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."ZOROrVi1:List:Filter"..sl)
...
if not AliZOROrViW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if AliZOROrViW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ZOROrVi_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✫' and AliZOROrViW(msg) then  
...
if text == 'تعطيل التواصل ✫' and AliZOROrViW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and AliZOROrViW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and AliZOROrViW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and AliZOROrViW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯⁞ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and AliZOROrViW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and AliZOROrViW(msg) then 
...
if text == 'تحديث السورس ✫' and AliZOROrViW(msg) then 
os.execute('rm -rf ZOROrVi.lua')
os.execute('https://raw.githubusercontent.com/jokerrr7/ZPROPLUS/main/ZOROrVi.lua')
send(msg.chat_id_, msg.id_,' *⌯⁞تم تحديث السورس* \n*⌯⁞لديك اخر اصدار لسورس زورو*\n*⌯⁞الاصدار » { 2.8v}*')
dofile('ZOROrVi.lua')  
end
if text == 'الاصدار ✫' and AliZOROrViW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯⁞اصدار سورس زورو* \n*⌯⁞الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and AliZOROrViW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯⁞[تحديثات البوت](t.me/SOURCE_ZORO_plus) \n⌯⁞[قناه السورس](t.me/SOURCE_ZORO_plus)')
end
if text == "ضع اسم للبوت ✫" and AliZOROrViW(msg) then  
...
if text == 'المشتركين ✫' and AliZOROrViW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ✫' and AliZOROrViW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯⁞الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and AliZOROrViW(msg) then
...
if text == ("قائمه العام ✫") and AliZOROrViW(msg) then
...
if text == ("قائمه الكتم العام ✫") and AliZOROrViW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and AliZOROrViW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and AliZOROrViW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and AliZOROrViW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الان اذاعتك؟* \n*⌯⁞للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and AliZOROrViW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯⁞ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and AliZOROrViW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯⁞ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and AliZOROrViW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and AliZOROrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ✫" and AliZOROrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯⁞عدد الجروبات الان » { '..#group..' }'..ZOROrVik..''..ZOROrVi..'*\n*⌯⁞الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and AliZOROrViW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and AliZOROrViW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and AliZOROrViW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and AliZOROrViW(msg) then
...
local ZOROrVi1_Msg = database:get(bot_id.."ZOROrVi1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZOROrVi1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if ZOROrVi_Msg and not Special(msg) then  
local ZOROrVi_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ZOROrVi_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not AliZOROrViW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and AliZOROrViW(msg) then
...
if text and text:match("^تغير الاشتراك$") and AliZOROrViW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and AliZOROrViW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and AliZOROrViW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯⁞تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and AliZOROrViW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯⁞حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and AliZOROrViW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and AliZOROrViW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯⁞تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and AliZOROrViW(msg) then  
...
database:sadd(bot_id.."ZOROrVi:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ZOROrVi:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ZOROrVi = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ZOROrVi then 
names_ZOROrVi = database:smembers(bot_id.."ZOROrVi:blocname"..msg.chat_id_) or ""
if names_ZOROrVi and names_ZOROrVi[1] then 
for i=1,#names_ZOROrVi do 
if name_ZOROrVi:match("(.*)("..names_ZOROrVi[i]..")(.*)") then 
...
database:set(bot_id.."ZOROrVi:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ZOROrVi:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ZOROrVi:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ZOROrVi:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ZOROrVi:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ZOROrVia_new(ZOROrVi1,ZOROrVi2)
if ZOROrVi2 and ZOROrVi2.first_name_ then 
if ZOROrVi2.first_name_:match("(.*)"..database:get(bot_id.."ZOROrVi:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZOROrVi:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ZOROrVi_nnn = database:get(bot_id.."ZOROrVi:nump"..msg.chat_id_) or 5
local ZOROrVi_nnn2 = database:get(bot_id.."ZOROrVi:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ZOROrVi_nnn2) == tonumber(ZOROrVi_nnn) or tonumber(ZOROrVi_nnn2) > tonumber(ZOROrVi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ZOROrVi:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯⁞عزيزي >>["..ZOROrVi2.username_.."](https://t.me/"..(ZOROrVi2.username_ or "SOURCE_ZORO_plus")..")\n⌯⁞عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZOROrVi:teh"..msg.chat_id_).."} بجانب اسمك\n⌯⁞عدد المحاولات المتبقيه {"..(tonumber(ZOROrVi_nnn) - tonumber(ZOROrVi_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ZOROrVia_new)
end
end
...
local ZOROrViChengName = database:get(bot_id.."ZOROrVi:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ZOROrViChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ZOROrViChengName..']')
database:del(bot_id.."ZOROrVi:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ZOROrViChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ZOROrVi:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ZOROrViChengUserName = database:get(bot_id.."ZOROrVi:Cheng:UserName"..data.id_)
if not data.username_ then 
if ZOROrViChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ZOROrViChengUserName..']')
database:del(bot_id.."ZOROrVi:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ZOROrViChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ZOROrVi:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ZOROrViChengPhoto = database:get(bot_id.."ZOROrVi:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ZOROrViChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ZOROrVi:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ZOROrViChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ZOROrVi:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and AliZOROrViW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and AliZOROrViW(msg) then
dofile('ZOROrVi.lua')  
send(msg.chat_id_, msg.id_, ' *⌯⁞تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and AliZOROrViW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and AliZOROrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if ZOROrViSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and AliZOROrViW(msg) then
...
if ZOROrViSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯⁞لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and AliZOROrViW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and AliZOROrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and AliZOROrViW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and AliZOROrViW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and AliZOROrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and AliZOROrViW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and AliZOROrViW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and AliZOROrViW(msg) then
...
if text == 'الملفات' and AliZOROrViW(msg) then
t = ' *⌯⁞ملفات السورس زورو ↓*\n*•━━━━━━ ZORO ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if AliZOROrViW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceZOROrVi/File_ZOROrVi/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and AliZOROrViW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceZOROrVi/File_ZOROrVi/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and AliZOROrViW(msg) then
...
if text == "مسح الملفات" and AliZOROrViW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯⁞تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and AliZOROrViW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and AliZOROrViW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_ZOROrVi(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZOROrVi, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ZOROrVi, nil)
return false 
end
...
database:set(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯⁞ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZOROrVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZOROrVi1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯⁞تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZOROrVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZOROrVi1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZOROrVi1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯⁞ارسل الكلمه الان*")  
database:set(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZOROrVi1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZOROrVi1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ZOROrVi1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZOROrVi1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZOROrVi1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZOROrVi1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and AliZOROrViW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯⁞تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and AliZOROrViW(msg) then
...
if text == 'تفعيل الاذاعه' and AliZOROrViW(msg) then  
...
if text == 'تعطيل الاذاعه' and AliZOROrViW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..ZOROrVi_Msg[math.random(#ZOROrVi_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not AliZOROrViW(msg) then 
...
if ZOROrViSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'Ali:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and AliZOROrViW(msg) then 
...
if text == ("ردود المطور") and AliZOROrViW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯⁞قائمة ردود المطور \n*•━━━━━━ ZORO ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and AliZOROrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and AliZOROrViW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and AliZOROrViW(msg) then   
...
if text == 'تعطيل المغادره' and AliZOROrViW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯⁞ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOROrViFiles')..') '
...
-- vardump(data) 
ZOROrVidx(msg.chat_id_, msg.id_, ' *⌯⁞ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯⁞عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯⁞عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯⁞عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and AliZOROrViW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━━━━ ZORO ━━━━━━━•*ٴ✫∫○ٴ\n⌯⁞[ZORO PLUS](t.me/SOURCE_ZORO_plus) ')
end
...
ZOROrVi = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ZOROrVi)
...
--------------------------------------------------------------------------------------------------------------
SourceZOROrVi(data.message_,data)
...
------------------------------------------------------------------------
local ZOROrViAbot = database:get(bot_id.."ZOROrVi1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOROrViAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯⁞["..ZOROrViAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ZOROrVi1_Msg = database:get(bot_id.."ZOROrVi1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOROrVi1_Msg then
send(msg.chat_id_, msg.id_," ⌯⁞"..ZOROrVi1_Msg)
